...
def purge_lims_logs():
    enqueue(method=clear_raw_astm_older_than, queue='long', timeout=7200)
    enqueue(method=clear_raw_hl7_older_than, queue='long', timeout=7200)
    enqueue(method=purge_astm_logs, queue='long', timeout=7200)
    enqueue(method=purge_hl7_logs, queue='long', timeout=7200)
